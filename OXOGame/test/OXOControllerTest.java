...
final class ControllerTests {
  ...
  void testHandleIncomingCommand() throws OXOMoveException {
    ...
    controller.handleIncomingCommand("0 0");
  ...
  void testBasicWinWithA1A2A3() throws OXOMoveException {
    ...
    OXOPlayer firstMovingPlayer = model.getPlayerByNumber(model.getCurrentPlayerNumber());
    controller.handleIncomingCommand("0 0");
    controller.handleIncomingCommand("1 0");
    controller.handleIncomingCommand("0 1");
    controller.handleIncomingCommand("1 1");
    controller.handleIncomingCommand("0 2");
